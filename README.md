...
The 0.1.2 release provides binaries for R 4.4, R 4.5, and R 4.6 on
...
Install the released 0.1.2 source package on Linux or
...
install.packages(
  "https://github.com/sayan-ch/netOP/releases/download/v0.1.2/netOP_0.1.2.tar.gz",
  repos = NULL,
  type = "source"
)
```
