...
# Windows, or when force_windows is TRUE, it attempts a temporary
# future::multisession plan with future.apply::future_lapply. Any backend error
# causes a safe fallback to base::lapply. The caller's existing future plan is
